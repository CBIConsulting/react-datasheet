    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _extends({
          ...
          className: [className, 'cell', overflow, selected && 'selected', editing && 'editing', readOnly && 'read-only', this.state.updated && 'updated', fixed && 'fixed-column'].filter(function (a) {
            return a;
          }).join(' '),
